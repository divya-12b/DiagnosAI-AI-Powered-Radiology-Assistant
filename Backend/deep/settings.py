...
SECRET_KEY = 'django-insecure-3#yb1t3gclc0s3z*3@=a(tffs4&8i-vcp=)b+c*6fqx7froh!z'
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')  # Folder to store the files on the disk
